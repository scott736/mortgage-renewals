...
const LINK_META: Record<string, LinkMeta> = {
  ...
  "/mortgage-renewal-payment-shock/": {
    title: "Payment Shock at Renewal 2026",
    blurb: "Why renewal payments rise in 2026 — and how to estimate and reduce the increase.",
  },
  ...
  "/fr/renouvellement-hypothecaire-quebec/": {
    title: "Renouvellement hypothécaire au Québec",
    blurb: "Guide québécois — notaire, AMF, Desjardins et changement de prêteur.",
  },
  "/fr/changer-preteur-renouvellement/": {
    title: "Changer de prêteur au renouvellement",
    blurb: "Transfert au renouvellement, exemption test de stress, frais au Québec.",
  },
  "/fr/faq-renouvellement-hypothecaire/": {
    title: "FAQ renouvellement (FR)",
    blurb: "Questions fréquentes sur le renouvellement hypothécaire au Canada.",
  },
  "/fr/guide-renouvellement-hypothecaire/": {
    title: "Guide de renouvellement — Résumé FR",
    blurb: "Calendrier 12 mois → échéance : magasiner, négocier, transférer.",
  },
