...
const LINK_META: Record<string, LinkMeta> = {
  ...
  "/investment-property-mortgage-rates/": {
    title: "Investment Property Mortgage Rates",
    blurb: "Rental rate premiums vs owner-occupied — how to shop the gap.",
  },
  "/dscr-mortgage-canada/": {
    title: "DSCR Mortgage Canada",
    blurb: "Qualify on property NOI — DSCR floors, renewal paths, Canada vs US.",
  },
  "/commercial-mortgage-canada/": {
    title: "Commercial Mortgage Canada",
    blurb: "Commercial & multi-family rates, DSCR underwriting, MLI Select.",
  },
  "/documents-required-mortgage-renewal/": {
    title: "Documents Required for Renewal",
    blurb: "Stay vs switch paperwork for salaried, self-employed, and rentals.",
  },
